...
using stringMap = CIL2Java.Maps.String;
...
namespace System
{
    ...
    public sealed class String : IComparable, ICloneable, IConvertible, IComparable<String>, IEnumerable<Char>, IEquatable<String>
    {
        ...
        public char this[int index]
        {
            ...
            get { throw new NotSupportedException("Direct call to mapped methods not supported"); }
        }
        ...
        [MethodMap(typeof(stringMap), "Join")]
        public static string Join(string separator, params string[] value)
        {
            throw new NotSupportedException("Direct call to mapped methods not supported");
        }
        ...
        [ReliabilityContractAttribute(Consistency.WillNotCorruptState, Cer.MayFail)]
        [MethodMap(typeof(stringMap), "Equals", true)]
        ...
        [MethodMap(typeof(stringMap), "Equals")]
        ...
        /// <summary>Determines whether two specified strings have the same value.</summary><returns>true if the value of <paramref name="a" /> is the same as the value of <paramref name="b" />; otherwise, false.</returns><param name="a">The first string to compare, or null. </param><param name="b">The second string to compare, or null. </param><filterpriority>3</filterpriority>
        [MethodMap(typeof(stringMap), "OperatorEq")]
        ...
        /// <summary>Determines whether two specified strings have different values.</summary><returns>true if the value of <paramref name="a" /> is different from the value of <paramref name="b" />; otherwise, false.</returns><param name="a">The first string to compare, or null. </param><param name="b">The second string to compare, or null. </param><filterpriority>3</filterpriority>
        [MethodMap(typeof(stringMap), "OperatorNotEq")]
        public static bool operator !=(string a, string b)
        {
            throw new NotSupportedException("Direct call to mapped methods not supported");
        }
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(stringMap), "CopyTo", true)]
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(javaString), "toCharArray", true)]
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(stringMap), "ToCharArray", true)]
        ...
        [MethodMap(typeof(stringMap), "IsNullOrEmpty")]
        ...
        [MethodMap(typeof(stringMap), "IsNullOrWhiteSpace")]
        ...
        [MethodMap(typeof(stringMap), "Split", true)]
        ...
        [MethodMap(typeof(javaString), "substring")]
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(stringMap), "Substring", true)]
        ...
        #region Trim
        [MethodMap(typeof(stringMap), "Trim", true)]
        public string Trim()
        {
            throw new NotSupportedException("Direct call to mapped methods not supported");
        }
        ...
        [MethodMap(typeof(stringMap), "TrimStart", true)]
        ...
        [MethodMap(typeof(stringMap), "TrimEnd", true)]
        ...
        #region Unsafe (unsupported) ctors
        ...
        [MethodMap(typeof(stringMap), "IsNormalized", true)]
        ...
        [MethodMap(typeof(stringMap), "Normalize", true)]
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(javaString), ".ctor")]
        ...
        [MethodMap(typeof(stringMap), "Compare")]
        ...
        [MethodMap(typeof(stringMap), "CompareTo", true)]
        ...
        [MethodMap(typeof(javaString), "compareTo", true)]
        ...
        [MethodMap(typeof(stringMap), "CompareOrdinal")]
        ...
        [MethodMap(typeof(stringMap), "IndexOf", true)]
        ...
        [MethodMap(typeof(stringMap), "IndexOfAny", true)]
        ...
        [MethodMap(typeof(javaString), "indexOf")]
        ...
        [MethodMap(typeof(stringMap), "LastIndexOf", true)]
        ...
        [MethodMap(typeof(stringMap), "LastIndexOfAny", true)]
        ...
        [MethodMap(typeof(javaString), "lastIndexOf")]
        ...
        [MethodMap(typeof(stringMap), "PadLeft", true)]
        ...
        [MethodMap(typeof(stringMap), "PadRight", true)]
        ...
        [MethodMap(typeof(javaString), "startsWith")]
        ...
        [SecuritySafeCriticalAttribute()]
        [ComVisibleAttribute(false)]
        [MethodMap(typeof(stringMap), "StartsWith", true)]
        ...
        [MethodMap(typeof(javaString), "endsWith")]
        ...
        [ComVisibleAttribute(false)]
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(stringMap), "EndsWith", true)]
        ...
        #region Case change
        [MethodMap(typeof(javaString), "toLowerCase")]
        ...
        [MethodMap(typeof(stringMap), "ToLower", true)]
        ...
        [MethodMap(typeof(stringMap), "ToLowerInvariant", true)]
        ...
        [MethodMap(typeof(javaString), "toUpperCase")]
        ...
        [MethodMap(typeof(stringMap), "ToUpper", true)]
        ...
        [MethodMap(typeof(stringMap), "ToUpperInvariant", true)]
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(stringMap), "Insert", true)]
        ...
        [MethodMap(typeof(javaString), "replace")]
        ...
        [MethodMap(typeof(stringMap), "Replace", true)]
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(stringMap), "Remove", true)]
        ...
        [MethodMap(typeof(stringMap), "Format")]
        ...
        [MethodMap(typeof(stringMap), "Concat")]
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(stringMap), "Intern")]
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(stringMap), "IsInterned")]
        ...
        [ReliabilityContractAttribute(Consistency.WillNotCorruptState, Cer.MayFail)]
        [SecuritySafeCriticalAttribute()]
        //will be automaticaly mapped to javaString.hashCode
        ...
        [MethodMap(typeof(stringMap), "Contains", true)]
        public bool Contains(string value)
        {
            throw new NotSupportedException("Direct call to mapped methods not supported");
        }

        // will be automaticaly mapped to javaString.toString
        ...
        [MethodMap(typeof(stringMap), "ToString", true)]
        public string ToString(IFormatProvider provider)
        {
            throw new NotSupportedException("Direct call to mapped methods not supported");
        }

        [MethodMap(typeof(stringMap), "Clone", true)]
        public object Clone()
        {
            throw new NotSupportedException("Direct call to mapped methods not supported");
        }
        ...
        [SecuritySafeCriticalAttribute()]
        [MethodMap(typeof(stringMap), "Copy")]
