...
namespace System.Security.AccessControl
{
    ...
    public abstract class ObjectAuditRule : AuditRule
    {
        ...
        /// <summary>Gets the type of object to which the <see cref="System.Security.AccessControl.ObjectAuditRule" /> applies.</summary><returns>The type of object to which the <see cref="System.Security.AccessControl.ObjectAuditRule" /> applies.</returns>
        public Guid ObjectType
        {
            get { throw new NotImplementedException(); }
        }
    
        /// <summary>Gets the type of child object that can inherit the <see cref="System.Security.AccessControl.ObjectAuditRule" /> object.</summary><returns>The type of child object that can inherit the <see cref="System.Security.AccessControl.ObjectAuditRule" /> object.</returns>
