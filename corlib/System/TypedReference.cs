...
namespace System
{
    ...
    public struct TypedReference
    {
        ...
        /// <summary>Checks if this object is equal to the specified object.</summary><returns>true if this object is equal to the specified object; otherwise, false.</returns><param name="o">The object with which to compare the current object. </param><exception cref="T:System.NotSupportedException">This method is not implemented. </exception><filterpriority>2</filterpriority>
        ...
        /// <summary>Converts the specified TypedReference to an Object.</summary><returns>An <see cref="T:System.Object" /> converted from a TypedReference.</returns><param name="value">The TypedReference to be converted. </param><filterpriority>1</filterpriority>
        ...
        /// <summary>Returns the type of the target of the specified TypedReference.</summary><returns>The type of the target of the specified TypedReference.</returns><param name="value">The value whose target's type is to be returned. </param><filterpriority>1</filterpriority>
        ...
        /// <summary>Returns the internal metadata type handle for the specified TypedReference.</summary><returns>The internal metadata type handle for the specified TypedReference.</returns><param name="value">The TypedReference for which the type handle is requested. </param><filterpriority>1</filterpriority>
        ...
        /// <summary>Converts the specified value to a TypedReference. This method is not supported.</summary><param name="target">The target of the conversion. </param><param name="value">The value to be converted. </param><exception cref="T:System.NotSupportedException">In all cases. </exception><filterpriority>1</filterpriority>
        [SecuritySafeCriticalAttribute()]
